...
async def handleGroupMessage(message: types.Message):
    return await message.delete()

    await message.answer_sticker("CAACAgIAAxkBAAIW4mRnZxWU4nBPrbd5R_ASAihi6bzQAALQDgACb-PgSoAL98-0VGRhLwQ")
...
async def handle_StartMessage(message: types.Message):
    ...
    if message.chat.type != "private" and OFF_GROUPS:
        ...
        if not await util.user_exists(userid):
            ...
            return await sendMainMenu(message, message.from_id, message.from_user.first_name, True)
